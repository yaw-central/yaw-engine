...
public class GltfTeaPotTest implements UpdateCallback {
    ...
    public GltfTeaPotTest(Item obj) {
        this.obj = obj;
    }
    ...
    public static void main(String[] args) {
        ...
        camera.translate(-4,-4,3);
        camera.rotateXYZ(20.7f, 10, 40);
        ...
        Path path = Paths.get("src/java/resources/models/Teapot.glb");
        try {
